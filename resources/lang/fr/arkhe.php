...
return [
    ...
    'install' => [
        ...
        'trait_missing' => "Le modèle :model n'utilise pas le trait Arkhe\\Main\\Concerns\\HasBackendProfile (qui fournit HasRoles). Ajoutez-le à votre modèle User, puis relancez : php artisan arkhe:main:install — répondez Non aux étapes déjà faites.",
